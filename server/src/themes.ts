...
export const THEMES: ThemeDefinition[] = [
...

  {
    ...
    emoji: '🎬',
    category: 'culture',
    source: { kind: 'playlists', queries: ['musiques de films cultes', 'bandes originales films', 'les plus grands thèmes du cinéma', 'movie soundtracks cultes'] },
  },
  {
    id: 'series',
    label: 'Séries TV',
    emoji: '📺',
    category: 'culture',
    source: { kind: 'playlists', queries: ['génériques séries tv', 'génériques séries cultes', 'musiques séries cultes', 'tv show theme songs'] },
  },
  {
    id: 'dessins-animes',
    ...
    emoji: '🎨',
    category: 'culture',
    source: { kind: 'playlists', queries: ['génériques dessins animés français', 'dessins animés cultes français', 'génériques dessins animés enfance', 'dessins animés club dorothée', 'dessins animés 90s 2000s français'] },
  },
  {
    id: 'animes',
    label: 'Animés & Mangas (Openings)',
    emoji: '🇯🇵',
    category: 'culture',
    source: { kind: 'playlists', queries: ['anime openings cultes', 'best anime openings', 'top anime openings', 'anime opening songs', 'anime openings popular'] },
  },
  {
    id: 'disney',
    label: 'Disney & Pixar (VF)',
    emoji: '🏰',
    category: 'culture',
    source: { kind: 'playlists', queries: ['disney chansons françaises', 'disney vf', 'les plus grandes chansons disney', 'disney français', 'disney chansons cultes'] },
  },
  {
    id: 'jeux-video',
    label: 'Jeux vidéo',
    emoji: '🎮',
    category: 'culture',
    source: { kind: 'playlists', queries: ['musiques jeux vidéo cultes', 'video game soundtracks classics', 'gaming music classics'] },
  },
  {
    id: 'pub',
